...
---
```{r, include=FALSE}
# Default knitr options for clean static output
...
# If you use HTML widgets (DT, plotly, etc.), uncomment this line:
# knitr::opts_chunk$set(screenshot.force = TRUE)  # requires webshot2
```
